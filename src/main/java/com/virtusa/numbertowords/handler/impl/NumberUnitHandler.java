...
public class NumberUnitHandler implements UnitHandler {
	...
	static final String AND_CONSTANT = "and ";
	...
	public String getUnitValue(Integer number) {
		...
		case 3:
			...
			break;
		case 4:
			stringBuilder.append(NumberUnitConstants.THOUSAND_CONSTANT.getUnit()).append(AND_CONSTANT);
			break;
		case 5:
			stringBuilder.append(NumberUnitConstants.MILLION_CONSTANT.getUnit()).append(AND_CONSTANT);
			break;
		case 6:
			stringBuilder.append(NumberUnitConstants.BILLION_CONSTANT.getUnit()).append(AND_CONSTANT);
			break;
		case 7:
			stringBuilder.append(NumberUnitConstants.TRILLION_CONSTANT.getUnit()).append(AND_CONSTANT);
			break;
		default:
